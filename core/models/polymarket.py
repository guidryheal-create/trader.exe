...
class SimpleMarketQuery(BaseModel):
    # identity
    id: str
    slug: str
    question: str
    ...
    # liquidity / volume (numeric, already provided)
    ...
    class Config:
        extra = "ignore"  # 🔥 everything else dies here
  


class SimpleEventQuery(BaseModel):
    # identity
    id: str
    slug: str
    title: str
